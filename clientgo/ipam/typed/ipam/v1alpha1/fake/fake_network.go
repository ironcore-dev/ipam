...
func (c *FakeNetworks) Apply(ctx context.Context, network *ipamv1alpha1.NetworkApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Network, err error) {
	if network == nil {
...
func (c *FakeNetworks) ApplyStatus(ctx context.Context, network *ipamv1alpha1.NetworkApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Network, err error) {
	if network == nil {
		return nil, fmt.Errorf("network provided to Apply must not be nil")
	}
	data, err := json.Marshal(network)
