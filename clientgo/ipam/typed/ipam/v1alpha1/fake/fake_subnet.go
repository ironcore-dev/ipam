...
func (c *FakeSubnets) Apply(ctx context.Context, subnet *ipamv1alpha1.SubnetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Subnet, err error) {
	if subnet == nil {
...
func (c *FakeSubnets) ApplyStatus(ctx context.Context, subnet *ipamv1alpha1.SubnetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Subnet, err error) {
	if subnet == nil {
		return nil, fmt.Errorf("subnet provided to Apply must not be nil")
	}
	data, err := json.Marshal(subnet)
