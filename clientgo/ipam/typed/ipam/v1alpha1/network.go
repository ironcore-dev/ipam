...
type NetworkInterface interface {
	...
	Apply(ctx context.Context, network *ipamv1alpha1.NetworkApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Network, err error)
	ApplyStatus(ctx context.Context, network *ipamv1alpha1.NetworkApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Network, err error)
	NetworkExpansion
}
...
func newNetworks(c *IpamV1alpha1Client, namespace string) *networks {
	return &networks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *networks) Apply(ctx context.Context, network *ipamv1alpha1.NetworkApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Network, err error) {
	if network == nil {
...
func (c *networks) ApplyStatus(ctx context.Context, network *ipamv1alpha1.NetworkApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Network, err error) {
	if network == nil {
		return nil, fmt.Errorf("network provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
