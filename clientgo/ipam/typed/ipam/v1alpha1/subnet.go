...
type SubnetInterface interface {
	...
	Apply(ctx context.Context, subnet *ipamv1alpha1.SubnetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Subnet, err error)
	ApplyStatus(ctx context.Context, subnet *ipamv1alpha1.SubnetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Subnet, err error)
	SubnetExpansion
}
...
func (c *subnets) Apply(ctx context.Context, subnet *ipamv1alpha1.SubnetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Subnet, err error) {
	if subnet == nil {
...
func (c *subnets) ApplyStatus(ctx context.Context, subnet *ipamv1alpha1.SubnetApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Subnet, err error) {
	if subnet == nil {
		return nil, fmt.Errorf("subnet provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
